...
from reinforce_trader.api.trades.models.trade import Trade, TradeUpdate
...
async def get_trades(request: Request, user_id: str, strategy: str = None, ticker: str = None, db_client: MongoClient = Depends(get_db_client)):
    return trades_service.get_trades(user_id, strategy, ticker, db_client)
...
@trades_router.delete("/{trade_id}", response_model=None, status_code=202)
