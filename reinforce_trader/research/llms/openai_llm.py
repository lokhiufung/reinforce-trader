...
from reinforce_trader.research.llms.base_llm import BaseLLM
from reinforce_trader.research.mixins.color_print_mixin import print


class OpenaiLLM(BaseLLM):
    llm_backend = 'openai'
    
    def __init__(self, llm_config, max_api_call_retries=3, debug=True):
    ...
    def run_function_call(self, messages, functions=[], function_call=None):
        ...
        res = self._try_request(params, api_calls_retried=0)
